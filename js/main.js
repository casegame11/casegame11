...
(function () {
    ...
    function g(f, z) {
        var G = -1, x = f ? f.length : 0;
        if ("number" == typeof x && -1 < x && x <= t) for (; ++G < x;) z(f[G], G, f); else e(f, z)
    }
    ...
    function k(f) {
        ...
        var x = p, B = f && "object" == typeof f && "String" != m(f);
        B && (x = f, f = null);
        var J = x.navigator || {}, A = J.userAgent || "";
        f || (f = A);
        var E = B ? !!J.likeChrome : /\bChrome\b/.test(f) && !/internal|\n/i.test(K.toString()),
            P = B ? "Object" : "ScriptBridgingProxyObject", S = B ? "Object" : "Environment",
            C = B && x.java ? "JavaPackage" : m(x.java), W = B ? "Object" : "RuntimeObject";
        S = (C = /\bJava/.test(C) && x.java) && m(x.environment) == S;
        var I = C ? "a" : "\u03b1", X = C ? "b" : "\u03b2", Z = x.document || {}, T = x.operamini || x.opera,
            aa = v.test(aa = B && T ? T["[[Class]]"] : m(T)) ? aa : T = null, a, r = f;
        B = [];
        var F = null, M = f == A;
        ...
        var H = function (R) {
                ...
                label: "WebKit",
                pattern: "AppleWebKit"
            }, "iCab", "Presto", "NetFront", "Tasman", "KHTML", "Gecko"]), w = function (R) {
                return n(R, function (Q, O) {
            ...
            N = z([{label: "BlackBerry", pattern: "BB10"}, "BlackBerry", {
                label: "Galaxy S",
                pattern: "GT-I9000"
                ...
                "iPod", "iPhone", "Kindle", {
                    ...
                    label: "Wii U",
                    pattern: "WiiU"
                }, "Wii", "Xbox One", {label: "Xbox 360", pattern: "Xbox"}, "Xoom"]), V = function (R) {
        ...
        if (M) {
            if (h(x, "global")) if (C && (a = C.lang.System, r = a.getProperty("os.arch"), D = D || a.getProperty("os.name") + " " + a.getProperty("os.version")), S) {
                try {
                ...
                w ||
                (w = "Rhino")
            } else "object" == typeof x.process && !x.process.browser && (a = x.process) && ("object" == typeof a.versions && ("string" == typeof a.versions.electron ? (B.push("Node " + a.versions.node), w = "Electron", A = a.versions.electron) : "string" == typeof a.versions.nw && (B.push("Chromium " + A, "Node " + a.versions.node), w = "NW.js", A = a.versions.nw)), w || (w = "Node.js", r = a.arch, D = a.platform, A = (A = /[\d.]+/.exec(a.version)) ? A[0] : null)); else m(a = x.runtime) == P ? (w = "Adobe AIR", D = a.flash.system.Capabilities.os) : m(a = x.phantom) == W ? (w = "PhantomJS",
        ...
        if ("Fennec" == w || "Firefox" == w && /\b(?:Android|Firefox OS)\b/.test(D)) w = "Firefox Mobile"; else if ("Maxthon" == w && A) A = A.replace(/\.[\d.]+/, ".x"); else if (/\bXbox\b/i.test(N)) "Xbox 360" == N && (D = null), "Xbox 360" == N && /\bIEMobile\b/.test(f) && B.unshift("mobile mode"); else if (!/^(?:Chrome|IE|Opera)$/.test(w) && (!w || N || /Browser|Mobi/.test(w)) || "Windows CE" != D && !/Mobi/i.test(f)) if ("IE" ==
            w && M) try {
            ...
            !v.test(a = k.call(e, f.replace(v, "") + ";")) && a.name && (a = "ing as " + a.name + ((a = a.version) ? " " + a : ""), v.test(w) ? (/\bIE\b/.test(a) && "Mac OS" == D && (D = null), a = "identify" + a) : (a = "mask" + a, w = aa ? l(aa.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(a) && (D = null), M || (A = null)), H = ["Presto"], B.push(a)); else w += " Mobile";
        if (a = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(f) || 0)[1]) {
            a = [parseFloat(a.replace(/\.(\d)$/, ".0$1")), a];
            if ("Safari" == w && "+" == a[1].slice(-1)) w = "WebKit Nightly", F = "alpha", A = a[1].slice(0, -1); else if (A ==
    ...
    var d = {"function": !0, object: !0}, p = d[typeof window] && window || this, u = d[typeof exports] && exports;
    d = d[typeof module] && module && !module.nodeType && module;
    var c = u && d && "object" == typeof global && global;
    !c || c.global !== c && c.window !== c && c.self !== c || (p = c);
    var t = Math.pow(2, 53) - 1, v = /\bOpera/;
    c = Object.prototype;
    var y = c.hasOwnProperty, K = c.toString, L = k();
...
function isIOSLessThen13() {
    var b = platform.os, g = b.family.toLowerCase();
...
function isIOS() {
    ...
    for (; b.length;) if (navigator.platform === b.pop()) return !0;
...
function getSize(b) {
    var g = b.toLowerCase(), l = window.document, e = l.documentElement;
    if (void 0 === window["inner" + b]) b = e["client" + b]; else if (window["inner" + b] != e["client" + b]) {
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        var l = Math.min(b / CANVAS_HEIGHT, g / CANVAS_WIDTH), e = Math.round(CANVAS_WIDTH * l);
        ...
        m = b / 2 - l / 2;
        var h = g / 2 - e / 2, q = CANVAS_WIDTH / e;
        if (h * q < -EDGEBOARD_X ||
...
function createBitmap(b, g, l) {
    var e = new createjs.Bitmap(b), m = new createjs.Shape;
...
function CSpriteLibrary() {
    ...
    this.addSprite = function (n, k) {
        ...
        var d = new Image;
        b[n] = g[n] = {szPath: k, oSprite: d, bLoaded: !1};
        l++;
        return !0
    };
...
var CANVAS_WIDTH = 1500, CANVAS_HEIGHT = 640, EDGEBOARD_X = 300, EDGEBOARD_Y = 0, FONT_GAME = "walibi0615bold",
    FPS_TIME = 1E3 / 24, DISABLE_SOUND_MOBILE = !1, STATE_LOADING = 0, STATE_MENU = 1, STATE_HELP = 1, STATE_GAME = 3,
    GAME_STATE_IDLE = 0, GAME_STATE_SPINNING = 1, GAME_STATE_SHOW_ALL_WIN = 2, GAME_STATE_SHOW_WIN = 3,
    REEL_STATE_START = 0, REEL_STATE_MOVING = 1, REEL_STATE_STOP = 2, ON_MOUSE_DOWN = 0, ON_MOUSE_UP = 1,
    ON_MOUSE_OVER = 2, ON_MOUSE_OUT = 3, ON_DRAG_START = 4, ON_DRAG_END = 5, REEL_OFFSET_X = 380, REEL_OFFSET_Y = 123,
    NUM_REELS = 5, NUM_ROWS = 3, NUM_SYMBOLS = 10,
    WILD_SYMBOL = 10, BONUS_SYMBOL = 9, NUM_PAYLINES = 5, SYMBOL_SIZE = 140, SPACE_BETWEEN_SYMBOLS = 10,
    MAX_FRAMES_REEL_EASE = 16, MIN_REEL_LOOPS, REEL_DELAY, REEL_START_Y = REEL_OFFSET_Y - 3 * SYMBOL_SIZE,
    REEL_ARRIVAL_Y = REEL_OFFSET_Y + 3 * SYMBOL_SIZE, TIME_SHOW_WIN, TIME_SHOW_ALL_WINS, MIN_BET, MAX_BET, TOTAL_MONEY,
    MAX_NUM_HOLD, UFO_WIDTH = 174, UFO_HEIGHT = 248, NUM_ALIEN = 3, NUM_SYMBOLS_FOR_BONUS = 3, PERC_WIN_BONUS_PRIZE_1,
    PERC_WIN_BONUS_PRIZE_2, PERC_WIN_BONUS_PRIZE_3, SOUNDTRACK_VOLUME = .5, WIN_OCCURRENCE, SLOT_CASH, MIN_WIN,
    BONUS_OCCURRENCE, PAYTABLE_VALUES,
    BONUS_PRIZE = [[5, 50, 100], [10, 100, 200], [50, 200, 500]], ENABLE_FULLSCREEN, ENABLE_CHECK_ORIENTATION,
...
TEXT_CURRENCY = "$";
var TEXT_PRELOADER_CONTINUE = "START", TEXT_NO_MONEY = "NO MONEY! DO YOU WANT TO RECHARGE?", TEXT_RECHARGE = "RECHARGE",
    TEXT_EXIT = "EXIT";
...
function CMain(b) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo = [];
        s_aSoundsInfo.push({path: "./sounds/", filename: "win", loop: !0, volume: 1, ingamename: "win"});
        s_aSoundsInfo.push({path: "./sounds/", filename: "press_but", loop: !1, volume: 1, ingamename: "press_but"});
        s_aSoundsInfo.push({
            path: "./sounds/", filename: "reel_stop", loop: !1, volume: 1,
            ingamename: "reel_stop"
        });
        s_aSoundsInfo.push({path: "./sounds/", filename: "reels", loop: !1, volume: 1, ingamename: "reels"});
        s_aSoundsInfo.push({path: "./sounds/", filename: "start_reel", loop: !1, volume: 1, ingamename: "start_reel"});
        s_aSoundsInfo.push({path: "./sounds/", filename: "choose_ufo", loop: !1, volume: 1, ingamename: "choose_ufo"});
        s_aSoundsInfo.push({path: "./sounds/", filename: "press_hold", loop: !1, volume: 1, ingamename: "press_hold"});
        s_aSoundsInfo.push({
            path: "./sounds/", filename: "reveal_alien", loop: !1, volume: 1,
    ...
    this.tryToLoadSound = function (d, p) {
        setTimeout(function () {
            s_aSounds[d.ingamename] = new Howl({
                src: [d.path + d.filename + ".mp3"], autoplay: !1, preload: !0,
                loop: d.loop, volume: d.volume, onload: s_oMain.soundLoaded, onloaderror: function (u, c) {
                    for (var t = 0; t < s_aSoundsInfo.length; t++) if (u === s_aSounds[s_aSoundsInfo[t].ingamename]._sounds[0]._id) {
                        s_oMain.tryToLoadSound(s_aSoundsInfo[t], !0);
                        break
                    }
                }, onplayerror: function (u) {
                    for (var c = 0; c < s_aSoundsInfo.length; c++) if (u === s_aSounds[s_aSoundsInfo[c].ingamename]._sounds[0]._id) {
...
var s_bMobile, s_bAudioActive = !0, s_bFullscreen = !1, s_iCntTime = 0, s_iTimeElaps = 0, s_iPrevTime = 0,
    s_iCntFps = 0, s_iCurFps = 0, s_oDrawLayer, s_oStage, s_oMain, s_oSpriteLibrary, s_oSoundTrack = null,
    s_aSoundsInfo;
...
function CTextButton(b, g, l, e, m, h, q, n) {
    ...
    this.tweenPosition = function (f, z, G, x, B, J, A) {
        createjs.Tween.get(y).wait(x).to({x: f, y: z}, G, B).call(function () {
            void 0 !== J && J.call(A)
        })
    };
...
function CToggle(b, g, l, e, m) {
    ...
    this._init = function (c, t, v, y, K) {
        ...
        K = new createjs.SpriteSheet({
            images: [v],
            frames: {width: v.width / 2, height: v.height, regX: v.width / 2 / 2, regY: v.height / 2},
...
function CBetBut(b, g, l) {
    ...
    this._init = function (k, d, p) {
        ...
        var u = new createjs.SpriteSheet({
            images: [p],
            frames: {width: p.width / 2, height: p.height, regX: 0, regY: 0},
...
function CMenu() {
    ...
    this._init = function () {
        ...
        s_oStage.addChild(t);
        createjs.Tween.get(t).to({alpha: 0}, 600).call(function () {
            t.visible =
                !1
        });
...
function CGame(b) {
    var g = !1, l, e, m = !0, h, q, n, k, d, p, u, c, t, v, y, K = 0, L, f, z, G, x, B, J, A, E, P, S, C, W, I,
        X = null, Z, T;
    this._init = function () {
        h = GAME_STATE_IDLE;
        l = !0;
    ...
    this.unload = function () {
        ...
        for (a = 0; a < NUM_ROWS; a++) for (var r = 0; r < NUM_REELS; r++) G[a][r].unload();
        Z.unload()
    };
    this._initReels = function () {
        var a = REEL_OFFSET_X, r = REEL_OFFSET_Y, F = 0;
        z = [];
        for (var M = 0; M <
    ...
    this._initStaticSymbols = function () {
        var a = REEL_OFFSET_X, r = REEL_OFFSET_Y;
        G = [];
    ...
    this._initHitAreaColumn = function () {
        ...
        for (r = 0; r < NUM_REELS; r++) {
            ...
            H.setVisible(!1);
            H.addEventListenerWithParams(ON_MOUSE_UP, this._onHitAreaCol, this, {index: r});
            F += 150;
            E.push(H)
        }
    };
    this.generateFinalSymbols = function () {
        for (var a = 0; a < NUM_ROWS; a++) for (var r = 0; r < NUM_REELS; r++) !1 === z[r].isHold() && (J[a][r] = s_aRandSymbols[Math.floor(Math.random() * s_aRandSymbols.length)]);
    ...
    this._checkForCombos = function () {
        x = [];
        for (var a = L = 0; a < d; a++) {
            var r = s_aPaylineCombo[a], F = [], M = J[r[0].row][r[0].col];
            if (M !== BONUS_SYMBOL) {
                var H = 1, w = 1;
                for (F.push({
                    row: r[0].row,
                ...
                for (; w < r.length; w++) if (J[r[w].row][r[w].col] === M || J[r[w].row][r[w].col] === WILD_SYMBOL) {
                    if (J[r[w].row][r[w].col] === BONUS_SYMBOL) break;
                    H++;
                    F.push({row: r[w].row, col: r[w].col, value: J[r[w].row][r[w].col]})
                } else break;
    ...
    this._checkForBonus = function () {
        e =
            !1;
        K = 0;
        for (var a = [], r = 0; r < NUM_ROWS; r++) for (var F = 0; F < NUM_REELS; F++) J[r][F] === BONUS_SYMBOL && (a.push({
            row: r,
            col: F,
            value: J[r][F]
        }), K++);
    ...
    this.reelArrived = function (a, r) {
        ...
        } else z[a].restart(this._generateRandSymbols(), !1); else z[a].restart(this._generateRandSymbols(), !1), 0 === a && q++
    };
    ...
    this._showWin = function () {
        ...
        u === x.length && (u = 0);
        -1 !== x[u].line && (a = x[u].line, I.showLine(a));
        a = x[u].list;
        for (r = 0; r <
    ...
    this._hideAllWins = function () {
        for (var a = 0; a < x.length; a++) for (var r = x[a].list, F = 0; F < r.length; F++) G[r[F].row][r[F].col].stopAnim();
        I.hideAllLines();
        u = p = 0;
        p = TIME_SHOW_WIN;
    ...
    this.removeWinShowing = function () {
        ...
        I.resetWin();
        for (var a = 0; a < NUM_ROWS; a++) for (var r = 0; r < NUM_REELS; r++) G[a][r].hide();
    ...
    this.onSpin =
        function () {
            ...
            if (l && v < t) T.show(); else {
                ...
                for (var a = 0; a < s_aSymbolWin.length; a++) for (var r = s_aSymbolWin[a], F = 0; F < r.length; F++) 0 !== r[F] && r[F] < MIN_WIN && (MIN_WIN = r[F]);
                MIN_WIN *= c;
                l && (v -= t, I.refreshMoney(v), SLOT_CASH += t, $(s_oMain).trigger("bet_placed", {
                    bet: c,
                    tot_bet: t
                }));
                if (!m && z[0].visible && z[1].visible && this._checkForCombos()) this._assignWin(); else if (SLOT_CASH < MIN_WIN) {
...
function CReelColumn(b, g, l, e) {
    ...
    this.restart = function (z, G) {
        ...
        if (h = G) {
            ...
            q = !0
        } else for (x = 0; x < NUM_ROWS; x++) L[x].gotoAndStop("moving")
    };
    ...
    this._updateStopping = function () {
        t++;
        if (t >= v) m = !1, t = 0, v = MAX_FRAMES_REEL_EASE, c = REEL_STATE_START, u = 0, h = !1, q && (q = !1, f.y = REEL_OFFSET_Y), s_oGame.stopNextReel(); else {
    ...
    this.update = function (z) {
        if (!1 !==
            m && (u++, u > p)) if (n) z === k && (m = !1, s_oGame.stopNextReel(), s_oGame.stopNextReel(), 0 === k && s_oGame.increaseReelLoops()); else switch (!1 === h && f.y > REEL_ARRIVAL_Y && s_oGame.reelArrived(k, d), c) {
...
function CPayTablePanel() {
    ...
    this._createPayouts = function () {
        b = [];
        g = [];
        for (var m = [{x: 430, y: 130}, {x: 650, y: 130}, {x: 880, y: 130}, {x: 1100, y: 130}, {
            x: 430,
            y: 232
        }, {x: 650, y: 232}, {x: 880, y: 232}, {x: 1100, y: 232}], h = 0, q = 0; q < s_aSymbolWin.length; q++) {
    ...
    this.resetHighlightCombo = function () {
        for (var m = 0; m < b.length; m++) for (var h =
    ...
    this.tweenAlpha = function (m, h) {
        var q = this;
        createjs.Tween.get(m).to({alpha: h}, 200).call(function () {
...
function CStaticSymbolCell(b, g, l, e) {
    ...
    this._init = function (d, p, u, c) {
        ...
        k.visible = !1;
        q = [];
        for (d = 0; d < NUM_SYMBOLS; d++) p = createSprite(s_aSymbolAnims[d], "static", 0, 0, SYMBOL_SIZE, SYMBOL_SIZE), p.stop(), p.x = u, p.y = c, p.on("animationend", this._onAnimEnded, null, !1, {index: d}), k.addChild(p), q[d] = p, q[d].visible = !1;
        d = {
            framerate: 60,
...
function CBonusPanel() {
    ...
    this.show = function (p, u) {
        ...
        d.visible = !0;
        createjs.Tween.get(d).to({alpha: 1}, 1E3);
    ...
    this.layAlien = function (p) {
        n.x = e[p].x;
        var u = this;
        createjs.Tween.get(n).to({y: 460}, 300).call(function () {
            u.endBonus()
        });
    ...
    this.endBonus = function () {
        k.text = "X " + l;
        createjs.Tween.get(k).to({alpha: 1}, 500);
        setTimeout(function () {
            d.alpha = 0;
            d.visible = !1;
...
function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        n.y = 385;
        d.addChild(n);
        createjs.Tween.get(d).to({alpha: 1}, 600, createjs.Ease.cubicOut);
        this.refreshButtonPos(s_iOffsetX, s_iOffsetY)
    };
...
CTLText.prototype = {
    constructor: CTLText, __autofit: function () {
        if (this._bFitText) {
            for (var b = this._iFontSize; (this._oText.getBounds().height > this._iHeight - 2 * this._iPaddingV || this._oText.getBounds().width > this._iWidth - 2 * this._iPaddingH) && !(b--, this._oText.font = b + "px " + this._szFont, this._oText.lineHeight = Math.round(b * this._fLineHeightFactor), this.__updateY(), this.__verticalAlign(), 8 > b);) ;
            this._iFontSize = b
        }
...
function CRechargePanel() {
    ...
    this.show = function () {
        h.alpha = 0;
        h.visible = !0;
        createjs.Tween.get(h).to({alpha: 1}, 600, createjs.Ease.cubicOut)
    };
    this.hide = function () {
        h.visible = !1
    };
